...
public:
    ...
    path_t(const path_t & other) = delete;
	path_t & operator=(const path_t & other) = delete;
...
{
public:
    areapath_t(std::size_t cities, matrix<std::uint16_t> & costs_matrix, std::uint16_t start_city)
        : m_costs{costs_matrix}
    {
    }
